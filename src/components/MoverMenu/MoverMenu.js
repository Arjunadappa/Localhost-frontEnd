...
import "./MoverMenu.css";
import closeIcon from "../../assets/close_icon.png";
import backIcon from "../../assets/back.svg";
import HomeIcon from "../../assets/home.svg";
import FolderIcon from "../../assets/folder-svg.svg"

const MoverMenu = (props) => (
    <div className="movermenu">
    
        <img className="movermenu__close-button" onClick={props.closeMover} src={closeIcon}/>
        ...
        <div className="movermenu__nav_wrapper"> 
            ...
            } onClick={props.goBack} src={backIcon}/>
            ...
            } onClick={props.goHome} src={HomeIcon}/>
        ...
        <div className="movermenu__main_wrapper">
            {props.state.folders.map((folder) => {
                ...
                return <div className={folder._id !== props.state.selected ? "file__item__listview file__item__listview--smaller-max-width" : "file__item__listview file__item__listview--smaller-max-width file__item--selected"} 
                    onClick={() => props.folderClick(folder._id, folder.folderName)}
                >
                    
                    <div className="file__item__listview__title__wrapper file__item__listview__title__wrapper--mover">
                        <img className="file__image__listview file__image__listview--mover" src={FolderIcon}/>
                        <h5 className={folder._id !== props.state.selected ? "file__title__listview file__title__listview--no-max file__title__listview--mover" : "file__title__listview file__title__listview--no-max file__title--selected file__title__listview--mover"}>{folder.folderName}</h5>
                    </div>
