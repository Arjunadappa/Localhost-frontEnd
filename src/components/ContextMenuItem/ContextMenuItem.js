...
class ContextItemContainer extends React.Component {
    ...
    render() {
        return (<div className="context__item" onClick={this.onClick}>
        <img className="context__item__image" src={this.props.image}/>
        <p className="context__item__title">{this.props.title}</p>
        </div>)
    }
}
