            ...
            {props.shareSelected.metadata.link ? 
                ...
                <div className="sharemenu--block">
                    ...
                    <div className="sharemenu__link__wrapper">
                        ...
                        <p onClick={props.copyLink} className="sharemenu__title">{'http://localhostfrontend.s3-website-us-east-1.amazonaws.com'}/download-page/{props.shareSelected._id}/{props.shareSelected.metadata.link}</p>
                    </div>
